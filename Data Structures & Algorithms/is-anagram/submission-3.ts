class Solution {
    ...
    isAnagram(s: string, t: string): boolean {
        ...
        // less loops time: o(n), space: o(s + t)
        if (s.length !== t.length) return false
        const sCharMap = new Map()
        const tCharMap = new Map()
        ...
        // third , use an array of length 26 - o(n), space = o(1)
